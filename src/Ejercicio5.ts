...
const CantidadStickersGrandes: number = parseInt("Ingrese la cantidad de stickers grandes que desea:");
const CantidadStickersPequeños: number = parseInt("Ingrese la cantidad de stickers pequeños que desea:");
